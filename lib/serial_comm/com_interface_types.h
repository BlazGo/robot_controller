...
typedef enum{
    ...
    CMD_SET_CURRENT_JOINT_ANGLES_FROM_ENCODERS,
    CMD_START_HOMING,
    CMD_EMERGENCY_STOP
}com_cmd_type_t;
...
const CommandInfo command_table[] = {
    ...
    {"CMD_SET_CURRENT_JOINT_ANGLES_FROM_ENCODERS", CMD_SET_CURRENT_JOINT_ANGLES_FROM_ENCODERS, 0},
    {"CMD_START_HOMING", CMD_START_HOMING, 0},
};
