  ...
  if (com.cmdReady){
    ...
    switch (com.cmd_robot.type){
      ...
      case CMD_SET_POSITION_CONTROL_PARADIGM:
        ...
        break;
      case CMD_SET_CART_CONTROL_MODE:
        test_robot.setMotionControlMode(CARTESIAN_CONTROL);
        break;
      case CMD_SET_JOINT_CONTROL_MODE:
        test_robot.setMotionControlMode(JOINT_CONTROL);
        break;  
      case CMD_ENABLE:
        test_robot.enableJoints();
        break;
